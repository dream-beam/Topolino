    ...
    "cells": [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["# Testing python interface for Thorlabs APT\n", "awojdyla@lbl.gov, Dec 2025"]
        },
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["motor_z.move_by(-10000)"]
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## connect to camera"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
